...
class MyDataloader(data.Dataset):
    ...
    def crawl_folders(self):
        ...
        for scene in self.scenes:
            ...
            for i in range(-min(self.frame_idxs), len(imgs) - max(self.frame_idxs)):  # 掐头去尾
                ...
                if self.has_gt:
                    sample = {'tgt': tgts, 'GT': gts, 'intrinsics': intrinsics}
                else:
                    sample = {'tgt': tgts, 'intrinsics': intrinsics}
    ...
    def __getitem__(self, index):
        ...
        for i in range(len(self.frame_idxs)):
            ...
            rgb_np, _ = self.transform(rgb_np, None)
...
class aDataset(MyDataloader):
    ...
    def val_transform(self, rgb, depth=None):
        depth_np = depth
